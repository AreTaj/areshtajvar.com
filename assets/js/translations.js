const translations = {
    ...
    es: {
        ...
        adsb_p1: "Las aeronaves transmiten constantemente su posición y velocidad GPS a través de ADS-B. Sin embargo, en zonas de conflicto como el Mar Báltico o el Mediterráneo Oriental, los datos de telemetría sufren interferencias o suplantación (spoofing), generando trayectorias e indicadores de altitud físicamente imposibles.",
        adsb_p2: "Diseñé un pipeline en Python para ingerir telemetría de vuelos en vivo desde la API de OpenSky Network. Para calcular la velocidad terrestre de forma dinámica a lo largo de consultas secuenciales, construí un sistema de seguimiento de estado (state tracking) mediante una base de datos local SQLite.",
        adsb_p3: "Para identificar el comportamiento anómalo, el sistema aplica filtros de restricciones físicas (ej. velocidades superiores a Mach 1) y un modelo de aprendizaje automático no supervisado. Específicamente, entrena un modelo Isolation Forest para detectar valores atípicos (outliers) en las discrepancias entre altitud barométrica y geométrica.",
