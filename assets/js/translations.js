const translations = {
    en: {
        ...
        project_migraine_tag: "Health Tech",
        project_migraine_title: "Migraine Navigator",
        project_migraine_desc: "A chronic symptom tracking and health analytics application designed with a low-friction, accessible interface.",
        ...
        project_migraine_tag_2: "Product Design",
        migraine_p1: "Tracking chronic conditions over time presents significant usability challenges, as self-reported symptom severity is inherently subjective and difficult to standardize.",
        migraine_p2: "During acute symptom episodes, light sensitivity, cognitive fatigue, and physical discomfort can make detailed screen interactions and complex data entry difficult.",
        migraine_p3: "Migraine Navigator provides a streamlined interface optimized for fast, tap-based logging during acute symptom episodes, eliminating tedious data entry and minimizing visual strain.",
        migraine_p4: "The application dynamically organizes triggers, symptoms, and treatments to surface a user's most relevant options, while tracking patterns over time to help users and healthcare providers better understand symptom episodes.",
        migraine_r1: "Low-friction, tap-first logging interface designed specifically to reduce cognitive load and visual fatigue during episodes.",
        migraine_r2: "Intelligent interface customization that personalizes trigger, medication, and symptom tracking based on individual usage patterns.",
        migraine_r3: "Longitudinal health tracking tools to visualize symptom patterns and uncover potential episode correlations.",
        ...
        swarm_r1: "Telemetry Decay Thresholds: Units stall when the signal decay rate is low (≤ 0.2) because stale telemetry signals persist too long. Setting the decay rate above 0.2 stops units from stalling, while tuning it above 0.5 increases capture speed, resolving matches in 150–300 steps instead of 500.",
    ...
    es: {
        ...
        project_migraine_tag: "Salud · Diseño",
        project_migraine_title: "Migraine Navigator",
        project_migraine_desc: "Una aplicación de seguimiento de síntomas crónicos y analítica de salud diseñada con una interfaz accesible y de baja fricción.",
        ...
        project_migraine_tag_2: "Diseño de Producto",
        migraine_p1: "El seguimiento de condiciones crónicas a lo largo del tiempo presenta importantes retos de usabilidad, ya que la valoración del dolor es subjetiva y compleja de estandarizar.",
        migraine_p2: "Durante episodios agudos de dolor o migraña, la sensibilidad a la luz, la fatiga cognitiva y el malestar físico dificultan la interacción con pantallas y la introducción detallada de datos.",
        migraine_p3: "Migraine Navigator ofrece una interfaz optimizada para un registro rápido mediante toques simples durante episodios agudos, eliminando la entrada de texto tediosa y reduciendo el esfuerzo visual.",
        migraine_p4: "La aplicación organiza de forma dinámica los factores desencadenantes, síntomas y tratamientos más relevantes para cada usuario, permitiendo un seguimiento continuo para comprender mejor los patrones de cada episodio.",
        migraine_r1: "Interfaz de registro táctil y accesible diseñada específicamente para minimizar la carga cognitiva y la fatiga visual durante episodios de dolor.",
        migraine_r2: "Personalización inteligente que adapta la selección de desencadenantes, medicamentos y síntomas según los patrones de uso individuales.",
        migraine_r3: "Herramientas de seguimiento temporal para visualizar la evolución de la condición y ayudar a identificar posibles correlaciones en los síntomas.",
        ...
        swarm_r1: "Umbrales de decaimiento de telemetría: Las unidades se estancan cuando la tasa de decaimiento es baja (≤ 0,2) porque las señales obsoletas persisten demasiado tiempo. Ajustar la tasa por encima de 0,2 evita el estancamiento, mientras que superando el 0,5 aumenta la velocidad de captura, resolviendo partidas en 150–300 pasos en lugar de 500.",
