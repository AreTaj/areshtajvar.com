const translations = {
    en: {
        ...
        momentum_results_l1: "<strong>Total Return:</strong> +163.92%",
        momentum_results_l2: "<strong>Annualized Return:</strong> +18.37%",
        momentum_results_l3: "<strong>Max Drawdown:</strong> -5.30%",
        momentum_results_l4: "<strong>Sharpe Ratio:</strong> 1.46",
        momentum_results_l5: "<strong>Sortino Ratio:</strong> 1.79",
        momentum_results_l6: "<strong>Win Rate:</strong> 46.70% (424 Total Trades)",
        momentum_results_p3: "<em>Note: The system's low drawdown profile (-5.30%) is a direct result of the long-only momentum constraint. During negative momentum regimes, the strategy holds a 100% cash allocation, eliminating market exposure.</em>",
        momentum_results_p4: "<strong>Holdout Validation (2023-2024, unseen data):</strong> Annualized Return: 13.96% | Sharpe: 1.18 | Max Drawdown: -5.42%"
    },
    es: {
        // Nav
        nav_about: "Sobre mí",
        ...
        momentum_results_l1: "<strong>Retorno Total:</strong> +163.92%",
        momentum_results_l2: "<strong>Retorno Anualizado:</strong> +18.37%",
        momentum_results_l3: "<strong>Drawdown Máximo:</strong> -5.30%",
        momentum_results_l4: "<strong>Ratio Sharpe:</strong> 1.46",
        momentum_results_l5: "<strong>Ratio Sortino:</strong> 1.79",
        momentum_results_l6: "<strong>Tasa de Aciertos:</strong> 46.70% (424 Operaciones Totales)",
        momentum_results_p3: "<em>Nota: El bajo perfil de drawdown del sistema (-5.30%) es resultado directo de la restricción de momentum 'solo largos'. Durante los regímenes de momentum negativo, la estrategia mantiene una asignación del 100% en efectivo, eliminando la exposición al mercado.</em>",
        momentum_results_p4: "<strong>Validación Fuera de Muestra (Holdout) (2023-2024, datos no vistos):</strong> Retorno Anualizado: 13.96% | Sharpe: 1.18 | Drawdown Máximo: -5.42%"
    }
};
